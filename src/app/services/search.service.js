class SearchService {
    ...
    get currentDetailData() {
        ...
        return (this.SharedData.evergreenApply && !!this.SharedData.evergreenDetailData) ? this.SharedData.evergreenDetailData : (this._.currentDetailData || (this._.currentDetailData = {}));
    }
